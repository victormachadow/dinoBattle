...
local options = { numFriends = 0 , numEn = 1 , dificult = 10 ,  side = "esq" , arrows = false , en1 = "green" , en2 = "green" , en3 = "green" , hpe = 10 }
...
composer.removeScene( "levelBatalha" )
...
if(numEn==3)then
timers[1] = timer.performWithDelay( 800 , ataca1 , -1 )
--timers[2] = timer.performWithDelay( 1500 , go2 , -1 )
--timers[3] = timer.performWithDelay( 1000 , go3 , -1 )
end

if(numEn==2)then
timers[1] = timer.performWithDelay( 1000 , ataca1 , -1 )
--timers[2] = timer.performWithDelay( 1500 , go2 , -1 )
